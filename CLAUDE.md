...
- Persisted state lives in `UserDefaults` under the `lightspot_` prefix (`lightspot_hotkey_option`, `lightspot_recent_app_bundle_ids`, `lightspot_auto_start_enabled`, `lightspot_pinned_commands`, `lightspot_custom_commands`).
